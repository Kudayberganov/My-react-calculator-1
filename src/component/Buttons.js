...
// Calculator tugmalarini shu yerdan oldim "./CalculatorButtons";
...
const Buttons = ({ inputHandler, clearInput, backspace, changePlusMinus, calculateAns }) => {
  ...
  return (
    <div className="show-btn">
      ...
      <button className="btn clr c_b" onClick={clearInput}>
        C
      </button>

      <button className="btn clr c_b" onClick={backspace}>
        ⌫
      </button>
